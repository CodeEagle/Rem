...
extension AppDelegate {
    ...
    internal func callRem() {
        ...
        let ad = Rem.Work(url: img, duration: 5, showBlank: true, imageOverBanner: imageView, enableTap: true, countdown: .countdown(.topRight), skip: .skip(.bottomRight)) { (state) in
